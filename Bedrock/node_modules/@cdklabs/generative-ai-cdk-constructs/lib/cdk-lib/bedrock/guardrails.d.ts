...
import { ContentPolicyConfigProps, ContextualGroundingPolicyConfigProps } from './content-policy';
...
export declare class Guardrail extends Construct {
    ...
    addContextualGroundingPolicyConfig(props: ContextualGroundingPolicyConfigProps[]): void;
