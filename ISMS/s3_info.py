...
if __name__ == "__main__":
    ...
    with open('s3_bucket_info.csv', 'w', newline='') as csv_file:
        ...
        writer.writerow(['Name', 'Bucket Encryption', 'Bucket Logging', 'ACL', 'Bucket Policy', 'Public Access Block'])
        ...
        for bucket in response["Buckets"]:
            ...
            writer.writerow([bucket_name, bucket_encryption, bucket_logging, bucket_acl, bucket_policy, public_access_block])
